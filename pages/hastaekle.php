...
<body>
    ...
    <main class="container mx-auto w-25 mt-5">
        <form method="POST" action="../db/hastakayit.php" x-data>
            ...
            <!-- Form Title -->
            <h1 class="fs-3 fw-light mt-2">Hasta Ekleme Formu</h1>
            ...
            <div class="col-md-12 mt-2">
                <label for="hasta_cinsiyet" class="form-label">Cinsiyet</label>
            
                <select class="form-select" id="hasta_cinsiyet" name="hasta_cinsiyet">
